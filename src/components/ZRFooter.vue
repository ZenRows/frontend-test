<template>
  <footer class="max-w-6xl mx-auto px-4 sm:px-6 w-full">
    <div
      class="sm:flex sm:items-center sm:justify-between py-4 sm:py-8 border-t border-gray-200"
    >
      <ul class="flex mb-4 sm:order-1 sm:ml-4 sm:mb-0">
        <li>
          <a
            ...
            href="https://twitter.com/zenrowsHQ"
            aria-label="Twitter"
            target="_blank"
        ...
        <li class="ml-4">
          <a
            class="flex justify-center items-center text-gray-600 hover:text-gray-900 bg-white hover:bg-white-100 rounded-full shadow transition duration-150 ease-in-out"
            href="https://www.linkedin.com/company/zenrows"
            aria-label="LinkedIn"
            target="_blank"
            rel="noopener nofollow"
            style="outline: none"
      ...
      <div class="text-sm text-gray-600 mr-4">
        © {{ new Date().getFullYear() }} ZenRows, Inc. All rights reserved.
      </div>
    </div>
  </footer>
</template>
